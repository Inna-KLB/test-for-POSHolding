...
/* harmony import */ var _modules_selectCar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/selectCar */ "./src/assets/js/modules/selectCar.js");
/* harmony import */ var _modules_createSquares__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/createSquares */ "./src/assets/js/modules/createSquares.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_createSquares__WEBPACK_IMPORTED_MODULE_1__["default"])(squareSection, circleSection);
  Object(_modules_selectCar__WEBPACK_IMPORTED_MODULE_0__["default"])();
});

/***/ }),

/***/ "./src/assets/js/modules/closeForm.js":
/*!********************************************!*\
  !*** ./src/assets/js/modules/closeForm.js ***!
  \********************************************/
...
/* harmony import */ var _createSquares__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createSquares */ "./src/assets/js/modules/createSquares.js");



var closeForm = function closeForm(mark, model, year, delivery) {
...
/* harmony default export */ __webpack_exports__["default"] = (closeForm);

/***/ }),

/***/ "./src/assets/js/modules/createCircle.js":
/*!***********************************************!*\
  !*** ./src/assets/js/modules/createCircle.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _showForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./showForm */ "./src/assets/js/modules/showForm.js");
...
var createCircle = function createCircle(containerSquare, containerCircle) {
  ...
  setTimeout(function () {
    circleText.addEventListener('click', function () {
      Object(_showForm__WEBPACK_IMPORTED_MODULE_1__["default"])();
    });
  }, 4000);
};

/* harmony default export */ __webpack_exports__["default"] = (createCircle);

/***/ }),

/***/ "./src/assets/js/modules/createSelectOptions.js":
/*!******************************************************!*\
  !*** ./src/assets/js/modules/createSelectOptions.js ***!
  \******************************************************/
/*! exports provided: default */
...
var createSelectOptions = function createSelectOptions(carsArray, select, parameter, text) {
  var carsParameters = []; // Перебираем все марки, модели и годы машин в соответствующие массивы

  for (var i = 0; i < carsArray.length; i++) {
    carsParameters.push("".concat(carsArray[i][parameter]));
  } // Убираем дубликаты значений в массивах


  var sortParameters = _toConsumableArray(new Set(carsParameters)); // Вставялем значения массивов в options


  for (var _i = -1; _i < sortParameters.length; _i++) {
    var option = document.createElement('option');

    if (_i === -1) {
      option.textContent = "".concat(text);
    } else {
      option.setAttribute('value', "".concat(sortParameters[_i]));
      option.innerHTML = "".concat(sortParameters[_i]);
    }
...
/* harmony default export */ __webpack_exports__["default"] = (createSelectOptions);

/***/ }),

/***/ "./src/assets/js/modules/createSquares.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/createSquares.js ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./src/assets/js/modules/selectCar.js":
/*!********************************************!*\
  !*** ./src/assets/js/modules/selectCar.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/getData */ "./src/assets/js/services/getData.js");
/* harmony import */ var _closeForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./closeForm */ "./src/assets/js/modules/closeForm.js");
/* harmony import */ var _createSelectOptions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./createSelectOptions */ "./src/assets/js/modules/createSelectOptions.js");
...
var selectCar = function selectCar() {
  ...
  Object(_services_getData__WEBPACK_IMPORTED_MODULE_6__["default"])().then(function (res) {
    ...
    Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(cars, selectMark, 'mark', 'Выберите марку автомобиля');
    Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(cars, selectModel, 'model', 'Выберите модель автомобиля');
    Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(cars, selectYear, 'year', 'Выберите год выпуска'); // При изменении значения марки авто обновляются последующие selects

    selectMark.addEventListener('change', function () {
      sortCarsByMark = [];
      markIndex = selectMark.options.selectedIndex, selectedMark = selectMark.options[markIndex].value;
      ...
      selectModel.length = 0;
      selectYear.length = 0;
      Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(sortCarsByMark, selectModel, 'model', 'Выберите модель автомобиля');
      Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(sortCarsByMark, selectYear, 'year', 'Выберите год выпуска');
    ...
    selectModel.addEventListener('change', function () {
      ...
      for (var i = 0; i < sortCarsByMark.length; i++) {
      ...
      selectYear.length = 0;
      Object(_createSelectOptions__WEBPACK_IMPORTED_MODULE_8__["default"])(sortCarsByModel, selectYear, 'year', 'Выберите год выпуска');
          ...
          $(function () {
            $('#calendar').datepicker({
              ...
              onSelect: function onSelect(formattedDate, date, inst) {
                ...
                inst.hide();
                Object(_closeForm__WEBPACK_IMPORTED_MODULE_7__["default"])(cars[i].mark, cars[i].model, cars[i].year, formattedDate);
              }
            });
          });
        }
...
/* harmony default export */ __webpack_exports__["default"] = (selectCar);

/***/ }),

/***/ "./src/assets/js/modules/setAnimationSquare.js":
/*!*****************************************************!*\
  !*** ./src/assets/js/modules/setAnimationSquare.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./src/assets/js/modules/showForm.js":
/*!*******************************************!*\
  !*** ./src/assets/js/modules/showForm.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _selectCar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectCar */ "./src/assets/js/modules/selectCar.js");
...
var showForm = function showForm() {
  ...
  if (modal.classList.contains('hide')) {
    ...
    Object(_selectCar__WEBPACK_IMPORTED_MODULE_0__["default"])();
  } else {
    modal.classList.add('hide');
  }
};

/* harmony default export */ __webpack_exports__["default"] = (showForm);
