...
/* harmony import */ var _services_getData__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/getData */ "./src/assets/js/services/getData.js");
...
var selectCar = function selectCar() {
  ...
  Object(_services_getData__WEBPACK_IMPORTED_MODULE_12__["default"])().then(function (res) {
    var cars = res['cars'];
    var marks = [];

    for (var i = 0; i < cars.length; i++) {
      marks.push("".concat(cars[i].mark));
    }

    var sortMarks = _toConsumableArray(new Set(marks));

    for (var _i = 0; _i < sortMarks.length; _i++) {
      var option = document.createElement('option');
      option.setAttribute('value', "".concat(sortMarks[_i]));
      option.innerHTML = "".concat(sortMarks[_i]);
